...
proc create_root_design { parentCell } {
  ...
  # Create instance: axi_ic_ps_e_0_S_AXI_HP0_FPD, and set properties
  set axi_ic_ps_e_0_S_AXI_HP0_FPD [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_ic_ps_e_0_S_AXI_HP0_FPD ]
  set_property -dict [ list \
   ...
   CONFIG.STRATEGY {2} \
 ] $axi_ic_ps_e_0_S_AXI_HP0_FPD

  # Create instance: axi_ic_ps_e_0_S_AXI_HP1_FPD, and set properties
  set axi_ic_ps_e_0_S_AXI_HP1_FPD [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_ic_ps_e_0_S_AXI_HP1_FPD ]
  set_property -dict [ list \
   CONFIG.M00_HAS_DATA_FIFO {2} \
   CONFIG.M00_HAS_REGSLICE {1} \
   CONFIG.NUM_MI {1} \
   ...
   CONFIG.S01_HAS_REGSLICE {1} \
   CONFIG.STRATEGY {2} \
 ] $axi_ic_ps_e_0_S_AXI_HP1_FPD

  # Create instance: axi_ic_ps_e_0_S_AXI_HP2_FPD, and set properties
  set axi_ic_ps_e_0_S_AXI_HP2_FPD [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_ic_ps_e_0_S_AXI_HP2_FPD ]
  set_property -dict [ list \
   CONFIG.M00_HAS_DATA_FIFO {2} \
   CONFIG.M00_HAS_REGSLICE {1} \
   CONFIG.NUM_MI {1} \
   ...
   CONFIG.S00_HAS_REGSLICE {1} \
   CONFIG.STRATEGY {0} \
 ] $axi_ic_ps_e_0_S_AXI_HP2_FPD

  # Create instance: axi_ic_ps_e_0_S_AXI_HP3_FPD, and set properties
  set axi_ic_ps_e_0_S_AXI_HP3_FPD [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_ic_ps_e_0_S_AXI_HP3_FPD ]
  set_property -dict [ list \
   CONFIG.M00_HAS_DATA_FIFO {2} \
   CONFIG.M00_HAS_REGSLICE {1} \
   CONFIG.NUM_MI {1} \
   ...
   CONFIG.S00_HAS_REGSLICE {1} \
   CONFIG.STRATEGY {0} \
 ] $axi_ic_ps_e_0_S_AXI_HP3_FPD

  # Create instance: axi_ic_ps_e_0_S_AXI_LPD, and set properties
  set axi_ic_ps_e_0_S_AXI_LPD [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_interconnect:2.1 axi_ic_ps_e_0_S_AXI_LPD ]
  set_property -dict [ list \
   CONFIG.M00_HAS_DATA_FIFO {2} \
   CONFIG.M00_HAS_REGSLICE {1} \
   CONFIG.NUM_MI {1} \
  ...
  # Create instance: axis_dwc_dm_5_tx_0, and set properties
  ...
  # Create instance: axis_dwc_dm_6_rx_0, and set properties
  set axis_dwc_dm_6_rx_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_dwidth_converter:1.1 axis_dwc_dm_6_rx_0 ]
  set_property -dict [ list \
  ...
  # Create instance: dm_6, and set properties
  ...
  # Create instance: top_ekf_1, and set properties
  set top_ekf_1 [ create_bd_cell -type ip -vlnv xilinx.com:hls:top_ekf:1.0 top_ekf_1 ]

  # Create instance: top_ekf_1_if, and set properties
  set top_ekf_1_if [ create_bd_cell -type ip -vlnv xilinx.com:ip:adapter_v3_0:1.0 top_ekf_1_if ]
  set_property -dict [ list \
   CONFIG.C_INPUT_SCALAR_0_WIDTH {32} \
   CONFIG.C_INPUT_SCALAR_1_WIDTH {32} \
   CONFIG.C_INPUT_SCALAR_2_WIDTH {32} \
   CONFIG.C_NUM_INPUT_BRAMs {5} \
   ...
   CONFIG.S_AXIS_BRAM_2_DEPTH {5184} \
   CONFIG.S_AXIS_BRAM_2_DMWIDTH {32} \
   CONFIG.S_AXIS_BRAM_2_MB_DEPTH {1} \
   CONFIG.S_AXIS_BRAM_2_WIDTH {32} \
   CONFIG.S_AXIS_BRAM_3_DEPTH {576} \
   CONFIG.S_AXIS_BRAM_3_DMWIDTH {32} \
   CONFIG.S_AXIS_BRAM_3_MB_DEPTH {1} \
   CONFIG.S_AXIS_BRAM_3_WIDTH {32} \
   CONFIG.S_AXIS_BRAM_4_DEPTH {10432} \
   CONFIG.S_AXIS_BRAM_4_DMWIDTH {32} \
   CONFIG.S_AXIS_BRAM_4_MB_DEPTH {1} \
   CONFIG.S_AXIS_BRAM_4_WIDTH {32} \
  ...
  connect_bd_intf_net -intf_net axi_ic_ps_e_0_M_AXI_HPM0_FPD_M00_AXI [get_bd_intf_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M00_AXI] [get_bd_intf_pins top_ekf_1_if/S_AXI]
  ...
  connect_bd_intf_net -intf_net axi_ic_ps_e_0_M_AXI_HPM0_FPD_M05_AXI [get_bd_intf_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M05_AXI] [get_bd_intf_pins dm_4/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_ic_ps_e_0_M_AXI_HPM0_FPD_M06_AXI [get_bd_intf_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M06_AXI] [get_bd_intf_pins dm_5/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_ic_ps_e_0_M_AXI_HPM0_FPD_M07_AXI [get_bd_intf_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M07_AXI] [get_bd_intf_pins dm_6/S_AXI_LITE]
  connect_bd_intf_net -intf_net axi_ic_ps_e_0_S_AXI_HP0_FPD_M00_AXI [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/M00_AXI] [get_bd_intf_pins ps_e_0/S_AXI_HP0_FPD]
  connect_bd_intf_net -intf_net axi_ic_ps_e_0_S_AXI_HP1_FPD_M00_AXI [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/M00_AXI] [get_bd_intf_pins ps_e_0/S_AXI_HP1_FPD]
  connect_bd_intf_net -intf_net axi_ic_ps_e_0_S_AXI_HP2_FPD_M00_AXI [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_HP2_FPD/M00_AXI] [get_bd_intf_pins ps_e_0/S_AXI_HP2_FPD]
  connect_bd_intf_net -intf_net axi_ic_ps_e_0_S_AXI_HP3_FPD_M00_AXI [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_HP3_FPD/M00_AXI] [get_bd_intf_pins ps_e_0/S_AXI_HP3_FPD]
  connect_bd_intf_net -intf_net axi_ic_ps_e_0_S_AXI_LPD_M00_AXI [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_LPD/M00_AXI] [get_bd_intf_pins ps_e_0/S_AXI_LPD]
  connect_bd_intf_net -intf_net axis_dwc_dm_0_tx_0_M_AXIS [get_bd_intf_pins axis_dwc_dm_0_tx_0/M_AXIS] [get_bd_intf_pins top_ekf_1_if/S_AXIS_FIFO_0]
  connect_bd_intf_net -intf_net axis_dwc_dm_1_tx_0_M_AXIS [get_bd_intf_pins axis_dwc_dm_1_tx_0/M_AXIS] [get_bd_intf_pins top_ekf_1_if/S_AXIS_BRAM_0]
  connect_bd_intf_net -intf_net axis_dwc_dm_2_tx_0_M_AXIS [get_bd_intf_pins axis_dwc_dm_2_tx_0/M_AXIS] [get_bd_intf_pins top_ekf_1_if/S_AXIS_BRAM_1]
  connect_bd_intf_net -intf_net axis_dwc_dm_3_tx_0_M_AXIS [get_bd_intf_pins axis_dwc_dm_3_tx_0/M_AXIS] [get_bd_intf_pins top_ekf_1_if/S_AXIS_BRAM_2]
  connect_bd_intf_net -intf_net axis_dwc_dm_4_tx_0_M_AXIS [get_bd_intf_pins axis_dwc_dm_4_tx_0/M_AXIS] [get_bd_intf_pins top_ekf_1_if/S_AXIS_BRAM_3]
  connect_bd_intf_net -intf_net axis_dwc_dm_5_tx_0_M_AXIS [get_bd_intf_pins axis_dwc_dm_5_tx_0/M_AXIS] [get_bd_intf_pins top_ekf_1_if/S_AXIS_BRAM_4]
  connect_bd_intf_net -intf_net axis_dwc_dm_6_rx_0_M_AXIS [get_bd_intf_pins axis_dwc_dm_6_rx_0/M_AXIS] [get_bd_intf_pins dm_6/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net dm_0_M_AXI_MM2S [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/S00_AXI] [get_bd_intf_pins dm_0/M_AXI_MM2S]
  ...
  connect_bd_intf_net -intf_net dm_1_M_AXI_MM2S [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_LPD/S00_AXI] [get_bd_intf_pins dm_1/M_AXI_MM2S]
  ...
  connect_bd_intf_net -intf_net dm_2_M_AXI_MM2S [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_HP3_FPD/S00_AXI] [get_bd_intf_pins dm_2/M_AXI_MM2S]
  ...
  connect_bd_intf_net -intf_net dm_3_M_AXI_MM2S [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_HP2_FPD/S00_AXI] [get_bd_intf_pins dm_3/M_AXI_MM2S]
  ...
  connect_bd_intf_net -intf_net dm_4_M_AXI_MM2S [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/S00_AXI] [get_bd_intf_pins dm_4/M_AXI_MM2S]
  connect_bd_intf_net -intf_net dm_5_M_AXIS_MM2S [get_bd_intf_pins axis_dwc_dm_5_tx_0/S_AXIS] [get_bd_intf_pins dm_5/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net dm_5_M_AXI_MM2S [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/S01_AXI] [get_bd_intf_pins dm_5/M_AXI_MM2S]
  connect_bd_intf_net -intf_net dm_6_M_AXI_S2MM [get_bd_intf_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/S01_AXI] [get_bd_intf_pins dm_6/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net top_ekf_1_F_i_V_PORTA [get_bd_intf_pins top_ekf_1/F_i_V_PORTA] [get_bd_intf_pins top_ekf_1_if/AP_BRAM_IARG_2_0]
  connect_bd_intf_net -intf_net top_ekf_1_H_i_V_PORTA [get_bd_intf_pins top_ekf_1/H_i_V_PORTA] [get_bd_intf_pins top_ekf_1_if/AP_BRAM_IARG_3_0]
  connect_bd_intf_net -intf_net top_ekf_1_fx_i_V_PORTA [get_bd_intf_pins top_ekf_1/fx_i_V_PORTA] [get_bd_intf_pins top_ekf_1_if/AP_BRAM_IARG_0_0]
  connect_bd_intf_net -intf_net top_ekf_1_hx_i_V_PORTA [get_bd_intf_pins top_ekf_1/hx_i_V_PORTA] [get_bd_intf_pins top_ekf_1_if/AP_BRAM_IARG_1_0]
  connect_bd_intf_net -intf_net top_ekf_1_if_M_AXIS_FIFO_0 [get_bd_intf_pins axis_dwc_dm_6_rx_0/S_AXIS] [get_bd_intf_pins top_ekf_1_if/M_AXIS_FIFO_0]
  connect_bd_intf_net -intf_net top_ekf_1_if_ap_ctrl [get_bd_intf_pins top_ekf_1/ap_ctrl] [get_bd_intf_pins top_ekf_1_if/ap_ctrl]
  connect_bd_intf_net -intf_net top_ekf_1_obs_V [get_bd_intf_pins top_ekf_1/obs_V] [get_bd_intf_pins top_ekf_1_if/AP_FIFO_IARG_0]
  connect_bd_intf_net -intf_net top_ekf_1_output_V [get_bd_intf_pins top_ekf_1/output_V] [get_bd_intf_pins top_ekf_1_if/AP_FIFO_OARG_0]
  connect_bd_intf_net -intf_net top_ekf_1_params_V_PORTA [get_bd_intf_pins top_ekf_1/params_V_PORTA] [get_bd_intf_pins top_ekf_1_if/AP_BRAM_IARG_4_0]

  # Create port connections
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/S00_ARESETN] [get_bd_pins proc_sys_reset_0/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins top_ekf_1_if/m_axis_fifo_0_aresetn] [get_bd_pins top_ekf_1_if/s_axi_aresetn] [get_bd_pins top_ekf_1_if/s_axis_bram_0_aresetn] [get_bd_pins top_ekf_1_if/s_axis_bram_1_aresetn] [get_bd_pins top_ekf_1_if/s_axis_bram_2_aresetn] [get_bd_pins top_ekf_1_if/s_axis_bram_3_aresetn] [get_bd_pins top_ekf_1_if/s_axis_bram_4_aresetn] [get_bd_pins top_ekf_1_if/s_axis_fifo_0_aresetn]
  connect_bd_net -net proc_sys_reset_2_interconnect_aresetn [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M01_ARESETN] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M02_ARESETN] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M03_ARESETN] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M04_ARESETN] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M05_ARESETN] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M06_ARESETN] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M07_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/S01_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/S01_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP2_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP2_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP2_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP3_FPD/ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP3_FPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP3_FPD/S00_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_LPD/ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_LPD/M00_ARESETN] [get_bd_pins axi_ic_ps_e_0_S_AXI_LPD/S00_ARESETN] [get_bd_pins proc_sys_reset_2/interconnect_aresetn]
  connect_bd_net -net proc_sys_reset_2_peripheral_aresetn [get_bd_pins axis_dwc_dm_0_tx_0/aresetn] [get_bd_pins axis_dwc_dm_1_tx_0/aresetn] [get_bd_pins axis_dwc_dm_2_tx_0/aresetn] [get_bd_pins axis_dwc_dm_3_tx_0/aresetn] [get_bd_pins axis_dwc_dm_4_tx_0/aresetn] [get_bd_pins axis_dwc_dm_5_tx_0/aresetn] [get_bd_pins axis_dwc_dm_6_rx_0/aresetn] [get_bd_pins dm_0/axi_resetn] [get_bd_pins dm_1/axi_resetn] [get_bd_pins dm_2/axi_resetn] [get_bd_pins dm_3/axi_resetn] [get_bd_pins dm_4/axi_resetn] [get_bd_pins dm_5/axi_resetn] [get_bd_pins dm_6/axi_resetn] [get_bd_pins proc_sys_reset_2/peripheral_aresetn] [get_bd_pins top_ekf_1_if/acc_aresetn]
  connect_bd_net -net ps_e_0_pl_clk1 [get_bd_pins proc_sys_reset_1/slowest_sync_clk] [get_bd_pins ps_e_0/pl_clk1]
  connect_bd_net -net ps_e_0_pl_clk2 [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M01_ACLK] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M02_ACLK] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M03_ACLK] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M04_ACLK] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M05_ACLK] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M06_ACLK] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M07_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP0_FPD/S01_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP1_FPD/S01_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP2_FPD/ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP2_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP2_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP3_FPD/ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP3_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_HP3_FPD/S00_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_LPD/ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_LPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_0_S_AXI_LPD/S00_ACLK] [get_bd_pins axis_dwc_dm_0_tx_0/aclk] [get_bd_pins axis_dwc_dm_1_tx_0/aclk] [get_bd_pins axis_dwc_dm_2_tx_0/aclk] [get_bd_pins axis_dwc_dm_3_tx_0/aclk] [get_bd_pins axis_dwc_dm_4_tx_0/aclk] [get_bd_pins axis_dwc_dm_5_tx_0/aclk] [get_bd_pins axis_dwc_dm_6_rx_0/aclk] [get_bd_pins dm_0/m_axi_mm2s_aclk] [get_bd_pins dm_0/s_axi_lite_aclk] [get_bd_pins dm_1/m_axi_mm2s_aclk] [get_bd_pins dm_1/s_axi_lite_aclk] [get_bd_pins dm_2/m_axi_mm2s_aclk] [get_bd_pins dm_2/s_axi_lite_aclk] [get_bd_pins dm_3/m_axi_mm2s_aclk] [get_bd_pins dm_3/s_axi_lite_aclk] [get_bd_pins dm_4/m_axi_mm2s_aclk] [get_bd_pins dm_4/s_axi_lite_aclk] [get_bd_pins dm_5/m_axi_mm2s_aclk] [get_bd_pins dm_5/s_axi_lite_aclk] [get_bd_pins dm_6/m_axi_s2mm_aclk] [get_bd_pins dm_6/s_axi_lite_aclk] [get_bd_pins proc_sys_reset_2/slowest_sync_clk] [get_bd_pins ps_e_0/pl_clk2] [get_bd_pins ps_e_0/saxi_lpd_aclk] [get_bd_pins ps_e_0/saxihp0_fpd_aclk] [get_bd_pins ps_e_0/saxihp1_fpd_aclk] [get_bd_pins ps_e_0/saxihp2_fpd_aclk] [get_bd_pins ps_e_0/saxihp3_fpd_aclk] [get_bd_pins top_ekf_1_if/acc_aclk] [get_bd_pins top_ekf_1_if/m_axis_fifo_0_aclk] [get_bd_pins top_ekf_1_if/s_axis_bram_0_aclk] [get_bd_pins top_ekf_1_if/s_axis_bram_1_aclk] [get_bd_pins top_ekf_1_if/s_axis_bram_2_aclk] [get_bd_pins top_ekf_1_if/s_axis_bram_3_aclk] [get_bd_pins top_ekf_1_if/s_axis_bram_4_aclk] [get_bd_pins top_ekf_1_if/s_axis_fifo_0_aclk]
  ...
  connect_bd_net -net top_ekf_1_if_ap_clk [get_bd_pins top_ekf_1/ap_clk] [get_bd_pins top_ekf_1_if/ap_clk]
  connect_bd_net -net top_ekf_1_if_ap_iscalar_0_dout [get_bd_pins top_ekf_1/ctrl] [get_bd_pins top_ekf_1_if/ap_iscalar_0_dout]
  connect_bd_net -net top_ekf_1_if_ap_iscalar_1_dout [get_bd_pins top_ekf_1/w1] [get_bd_pins top_ekf_1_if/ap_iscalar_1_dout]
  connect_bd_net -net top_ekf_1_if_ap_iscalar_2_dout [get_bd_pins top_ekf_1/w2] [get_bd_pins top_ekf_1_if/ap_iscalar_2_dout]
  connect_bd_net -net top_ekf_1_if_ap_resetn [get_bd_pins top_ekf_1/ap_rst_n] [get_bd_pins top_ekf_1_if/ap_resetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/ACLK] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/M00_ACLK] [get_bd_pins axi_ic_ps_e_0_M_AXI_HPM0_FPD/S00_ACLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps_e_0/pl_clk0] [get_bd_pins top_ekf_1_if/s_axi_aclk]
  ...
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_0/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_1/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP6/LPD_DDR_LOW] SEG_ps_e_0_LPD_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_2/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP5/HP3_DDR_LOW] SEG_ps_e_0_HP3_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_3/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP4/HP2_DDR_LOW] SEG_ps_e_0_HP2_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_4/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_ps_e_0_HP1_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_5/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP2/HP0_DDR_LOW] SEG_ps_e_0_HP0_DDR_LOW
  create_bd_addr_seg -range 0x80000000 -offset 0x00000000 [get_bd_addr_spaces dm_6/Data_S2MM] [get_bd_addr_segs ps_e_0/SAXIGP3/HP1_DDR_LOW] SEG_ps_e_0_HP1_DDR_LOW
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0xA0004000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs dm_4/S_AXI_LITE/Reg] SEG_dm_4_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0005000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs dm_5/S_AXI_LITE/Reg] SEG_dm_5_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0xA0006000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs dm_6/S_AXI_LITE/Reg] SEG_dm_6_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0xA0010000 [get_bd_addr_spaces ps_e_0/Data] [get_bd_addr_segs top_ekf_1_if/S_AXI/reg0] SEG_top_ekf_1_if_reg0

  # Exclude Address Segments
  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_0/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_0/Data_MM2S/SEG_ps_e_0_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_1/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP6/LPD_LPS_OCM] SEG_ps_e_0_LPD_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_1/Data_MM2S/SEG_ps_e_0_LPD_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_2/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP5/HP3_LPS_OCM] SEG_ps_e_0_HP3_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_2/Data_MM2S/SEG_ps_e_0_HP3_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_3/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP4/HP2_LPS_OCM] SEG_ps_e_0_HP2_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_3/Data_MM2S/SEG_ps_e_0_HP2_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_4/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_ps_e_0_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_4/Data_MM2S/SEG_ps_e_0_HP1_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_5/Data_MM2S] [get_bd_addr_segs ps_e_0/SAXIGP2/HP0_LPS_OCM] SEG_ps_e_0_HP0_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_5/Data_MM2S/SEG_ps_e_0_HP0_LPS_OCM]

  create_bd_addr_seg -range 0x01000000 -offset 0xFF000000 [get_bd_addr_spaces dm_6/Data_S2MM] [get_bd_addr_segs ps_e_0/SAXIGP3/HP1_LPS_OCM] SEG_ps_e_0_HP1_LPS_OCM
  exclude_bd_addr_seg [get_bd_addr_segs dm_6/Data_S2MM/SEG_ps_e_0_HP1_LPS_OCM]
